package ro.pub.cs.systems.eim.practicaltest02test.view;
...
import ro.pub.cs.systems.eim.practicaltest02test.R;
import ro.pub.cs.systems.eim.practicaltest02test.general.Constants;
import ro.pub.cs.systems.eim.practicaltest02test.network.ClientThread;
import ro.pub.cs.systems.eim.practicaltest02test.network.ServerThread;

public class PracticalTest02Test2MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_practical_test02_test2_main);
